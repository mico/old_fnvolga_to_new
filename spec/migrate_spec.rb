...
RSpec.describe 'migration' do
  ...
  let(:migration_issue) { Migration.new('issue', config_with_relation['issue'], 1) }
  ...
  it 'should return INSERT INTO Issue ... for each INSERT INTO Article for belongs_to relation'
